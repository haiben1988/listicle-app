...
class ArmchairPage extends StatefulWidget {
  const ArmchairPage({super.key});

  @override
  State<ArmchairPage> createState() => _ArmchairPageState();
}

class _ArmchairPageState extends State<ArmchairPage> {
  @override
